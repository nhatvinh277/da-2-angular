import { LayoutConfigModel } from '../pages/_layout/models/layout-config.model';
...
export class LayoutConfig {
	public defaults: LayoutConfigModel = {
		...
		'loader': {
			'enabled': true,
			'type': 'spinner-logo',
			'logo': './assets/app/media/img/logos/Logo_nho.png',
			'message': 'Please wait...'
		},
		...
		'header': {
			...
			'topbar': {
				...
				'languages': { display: true },
				'cart': { display: false },
				'quick-panel': { display: true },
				'icon-style': 'duotone'
			},
